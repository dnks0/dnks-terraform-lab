...
inputs = {
  ...
  arm_client_secret     = include.root.locals.arm_client_secret
  arm_subscription_id   = include.root.locals.arm_subscription_id
  arm_tenant_id         = include.root.locals.arm_tenant_id
